...
const News = () => {
  ...
  const fetchData = async () => {
    let resonse = await fetch(
      "https://newsapi.org/v2/top-headlines?country=in&apiKey=903c4c18012046bc8cd432df628040ce"
    );
  ...
  return (
    <>
    <h1 className="text-center my-3">Daily Top Headlines</h1>
      ...
      {mynews.map((ele) => {
        ...
        <div class="card" style={{  marginTop:"2rem" , boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px"}}>
              ...
              <div class="card-body">
                ...
                <a href={ele.url} target="_blank" class="btn btn-dark">
                  Read More
                </a>
              </div>
            </div>
